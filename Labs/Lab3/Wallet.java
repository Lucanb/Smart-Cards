...
public class Wallet extends Applet {
    ...
    private void reset_pin_try_counter(APDU apdu){
    	...
    	{
    		if(!(PIN_COUNTER == 0x11 && buffer[ ISO7816.OFFSET_CDATA+1] == PUK[i]))
    		{
    			//aici fac resetare de try-uri(pt pin) - cazul favorabil
    			sw = 0x01;
    			break;
    		}
    		
    	}
    	if (PIN_COUNTER == 0x11 && sw == 0x00) {
    		PIN_COUNTER = 0x00; //aici fac reset
    	}
    }//end reset method
   }